...
export default function SignUp() {
  ...
  const [isSigningUpWithGoogle, setIsSigningUpWithGoogle] =
    React.useState(false);
  const [isSigningUpWithFacebook, setIsSigningUpWithFacebook] =
    React.useState(false);
  ...
  if (verifying) {
    return (
      <section className="flex px-4 py-16 h-dvh">
        <form
        ...
        <div className="bg-card -m-px rounded-[calc(var(--radius)+.125rem)] border p-8 pb-6">
          ...
          <div className="mt-6 space-y-6">
            ...
            <Button
              className="w-full"
              type="submit"
              disabled={isSigningUp || isSigningUpWithPassword}
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              type="button"
              variant="outline"
              disabled={isSigningUp || isSigningUpWithFacebook}
              onClick={() => {
                setIsSigningUpWithFacebook(true);
            ...
            >
              ...
              <span className="font-display">Facebook</span>
            </Button>
          </div>
        </div>
